...
exports.ProjectTestPlanAttributesApi = exports.ProjectTestPlanAttributesApiApiKeys = void 0;
const request_1 = __importDefault(require("request"));
const models_1 = require("../model/models");
const models_2 = require("../model/models");
const apis_1 = require("./apis");
let defaultBasePath = 'http://localhost';
var ProjectTestPlanAttributesApiApiKeys;
(function (ProjectTestPlanAttributesApiApiKeys) {
    ProjectTestPlanAttributesApiApiKeys[ProjectTestPlanAttributesApiApiKeys["Bearer or PrivateToken"] = 0] = "Bearer or PrivateToken";
})(ProjectTestPlanAttributesApiApiKeys = exports.ProjectTestPlanAttributesApiApiKeys || (exports.ProjectTestPlanAttributesApiApiKeys = {}));
class ProjectTestPlanAttributesApi {
    ...
    setApiKey(key, value) {
        this.authentications[ProjectTestPlanAttributesApiApiKeys[key]].apiKey = value;
    }
    addInterceptor(interceptor) {
        this.interceptors.push(interceptor);
    }
    createCustomAttributeTestPlanProjectRelations(projectId, requestBody, options = { headers: {} }) {
    ...
    deleteCustomAttributeTestPlanProjectRelations(projectId, attributeId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getCustomAttributeTestPlanProjectRelations(projectId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/v2/projects/{projectId}/testPlans/attributes'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
    ...
    searchTestPlanAttributesInProject(projectId, skip, take, orderBy, searchField, searchValue, projectAttributesFilterModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateCustomAttributeTestPlanProjectRelations(projectId, customAttributeTestPlanProjectRelationPutModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/v2/projects/{projectId}/testPlans/attributes'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
...
exports.ProjectTestPlanAttributesApi = ProjectTestPlanAttributesApi;
//# sourceMappingURL=projectTestPlanAttributesApi.js.map