...
(function (NotificationsApiApiKeys) {
    NotificationsApiApiKeys[NotificationsApiApiKeys["Bearer or PrivateToken"] = 0] = "Bearer or PrivateToken";
...
class NotificationsApi {
    ...
    apiV2NotificationsCountGet(isRead, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isRead !== undefined) {
                localVarQueryParameters['isRead'] = models_1.ObjectSerializer.serialize(isRead, "boolean");
            }
    ...
    apiV2NotificationsGet(notificationType, skip, take, orderBy, searchField, searchValue, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (notificationType !== undefined) {
                localVarQueryParameters['notificationType'] = models_1.ObjectSerializer.serialize(notificationType, "NotificationTypeModel");
            }
            if (skip !== undefined) {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<NotificationModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    apiV2NotificationsIdReadPost(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    apiV2NotificationsReadPost(options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    apiV2NotificationsSearchPost(skip, take, orderBy, searchField, searchValue, notificationQueryFilterModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(notificationQueryFilterModel, "NotificationQueryFilterModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
