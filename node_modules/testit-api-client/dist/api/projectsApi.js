...
class ProjectsApi {
    ...
    _import(includeAttachments, file, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (includeAttachments !== undefined) {
                localVarQueryParameters['includeAttachments'] = models_1.ObjectSerializer.serialize(includeAttachments, "boolean");
            }
    ...
    addGlobaAttributesToProject(id, requestBody, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    apiV2ProjectsDemoPost(projectPostModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(projectPostModel, "ProjectPostModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<FailureClassModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    apiV2ProjectsIdTestRunsActiveGet(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    apiV2ProjectsIdTestRunsFullGet(id, includeTestResults, mustAggregateTestResults, notStarted, inProgress, stopped, completed, createdDateFrom, createdDateTo, testPlanId, skip, take, orderBy, searchField, searchValue, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (includeTestResults !== undefined) {
                localVarQueryParameters['includeTestResults'] = models_1.ObjectSerializer.serialize(includeTestResults, "boolean");
            }
            if (mustAggregateTestResults !== undefined) {
                localVarQueryParameters['mustAggregateTestResults'] = models_1.ObjectSerializer.serialize(mustAggregateTestResults, "boolean");
            }
            ...
            if (createdDateFrom !== undefined) {
                localVarQueryParameters['createdDateFrom'] = models_1.ObjectSerializer.serialize(createdDateFrom, "Date");
            }
            if (createdDateTo !== undefined) {
                localVarQueryParameters['createdDateTo'] = models_1.ObjectSerializer.serialize(createdDateTo, "Date");
            }
            if (testPlanId !== undefined) {
                localVarQueryParameters['testPlanId'] = models_1.ObjectSerializer.serialize(testPlanId, "string");
            }
            if (skip !== undefined) {
    ...
    apiV2ProjectsPurgeBulkPost(projectSelectModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(projectSelectModel, "ProjectSelectModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
    ...
    apiV2ProjectsSearchPost(skip, take, orderBy, searchField, searchValue, projectsFilterModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(projectsFilterModel, "ProjectsFilterModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<ProjectModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    backgroundImportProject(file, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    backgroundImportZipProject(file, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createProject(projectPostModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    exportWithTestPlansAndConfigurations(id, includeAttachments, projectExportWithTestPlansPostModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                encoding: null,
                body: models_1.ObjectSerializer.serialize(projectExportWithTestPlansPostModel, "ProjectExportWithTestPlansPostModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
    ...
    getAllProjects(isDeleted, projectName, skip, take, orderBy, searchField, searchValue, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (projectName !== undefined) {
                localVarQueryParameters['projectName'] = models_1.ObjectSerializer.serialize(projectName, "string");
            }
            if (skip !== undefined) {
                localVarQueryParameters['Skip'] = models_1.ObjectSerializer.serialize(skip, "number");
            }
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<TestPlanModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<TestRunV2GetModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    updateProject(projectPutModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/v2/projects';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(projectPutModel, "ProjectPutModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
